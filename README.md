...
| -------------------------- | ------ | ---------------------------------- | -------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------- |
| Q1: Fundamentos            | Mês 1  | Base do Projeto                    | NerdOS                                                   | Git Intermediário (rebase, squash) e SQL Básico (CRUD, Agregações, Ordenações). SOLID (S).                             |
|                            | Mês 2  | Base do Projeto, Testes e Feedback | NerdOS                                                   | Testes Unitários (Jest) e Testes de Integração (Supertest). SOLID (S e D).                                             |
|                            | Mês 3  | SQL Profundo                       | NerdOS                                                   | PostgreSQL (Joins, Índices, Tipos de dados do Postgres e Views). Docker (Básico -> Intermediário).                     |
| Q2: Entrega e CI/CD        | Mês 4  | Deploy e Express                   | Fim do MVP do NerdOS + Início do Projeto em Trio         | Cloud (Nível 1 - Deploy em Free Tier).                                                                                 |
