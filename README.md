...
| Trimestre                  | Mês    | Foco Principal               | Projetos e Aplicação Prática                                 | Tópicos de Estudo (Novo/Ajustado)                                                                                          |
| -------------------------- | ------ | ---------------------------- | ------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------- |
| Q1: Fundamentos            | Mês 1  | Foco no Cliente              | Projeto do Cliente                                           | Git Intermediário (rebase, squash) e Testes Unitários (Jest). SOLID (S e D).                                               |
|                            | Mês 2  | Testes, Qualidade e Feedback | Projeto do Cliente                                           | Testes de Integração (Jest). SOLID (S e D).                                                                                |
|                            | Mês 3  | SQL Profundo                 | Projeto do Cliente                                           | PostgreSQL (Agregações, Ordenações, Joins, Índices, Tipos de dados do Postgres e Views). Docker (Básico -> Intermediário). |
| Q2: Entrega e CI/CD        | Mês 4  | Deploy e Express             | Fim do Projeto do Cliente + Início do Projeto Trio (Express) | Cloud (Nível 1 - Deploy em Free Tier).                                                                                     |
|                            | Mês 5  | Testes de Integração         | Projeto Trio (Express)                                       | Testes de Integração (Supertest). Conceitos de CI.                                                                         |
|                            | Mês 6  | Automação (CI/CD)            | Projeto Trio (Express)                                       | CI/CD (GitHub Actions).                                                                                                    |
...
|                            | Mês 14 | Preparação Técnica           | Resolução de problemas                                       | Estrutura de Dados & Algoritmos (Básico/Intermediário).                                                                    |
